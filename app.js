...
app.controller('MainCtrl', ['$scope', '$http', '$timeout', '$interval', 'uiGridConstants', 'uiGridGroupingConstants', '$filter',
 function ($scope, $http, $timeout, $interval, uiGridConstants, uiGridGroupingConstants, $filter) {
     var gridApi;
     $scope.selectedRows = [];
     $scope.gridApi;
     ...
     $scope.gridOptions = {
         ...
         columnDefs: [
      { name: 'SYMBOL' },
      { name: 'CLOSE', type: 'number', headerCellClass: "highlight", cellClass: "highlight", filters: [
        {
       ...
       { name: 'PIVOT', type: 'number', headerCellClass: "highlight", cellClass: "highlight", field: 'PIVOT',
     ...
     { name: 'DIFF', type: 'number', field: 'DIFF', filters: [
        {
            condition: uiGridConstants.filter.GREATER_THAN,
            placeholder: 'greater than',
            term: "1"
    ...
    { name: 'DIFF%', type: 'number', field: 'DIFFPer', filters: [
        {
            condition: uiGridConstants.filter.GREATER_THAN,
            placeholder: 'greater than'
     ...
     { name: 'ACTION' },
       { name: 'S1', type: 'number', field: 'S1', filters: [
        {
            condition: uiGridConstants.filter.GREATER_THAN,
            placeholder: 'greater than'
        },
       ...
       { name: 'R1', type: 'number', field: 'R1', filters: [
        {
            condition: uiGridConstants.filter.GREATER_THAN,
            placeholder: 'greater than'
        },
     ...
     { name: 'BUY', type: 'number', filters: [
              ...
              { name: 'STOPLOSS', type: 'number', filters: [
                 {
                     condition: uiGridConstants.filter.GREATER_THAN,
                     placeholder: 'greater than'
                 },
       ...
       { name: 'TOTTRDQTY', type: 'number', enableCellEdit: true, sort: { direction: uiGridConstants.DESC, priority: 0 }, aggregationType: uiGridConstants.aggregationTypes.avg, treeAggregationType: uiGridGroupingConstants.aggregation.AVG, filters: [
        {
            condition: uiGridConstants.filter.GREATER_THAN,
            placeholder: 'greater than'
        },
       ...
       { name: 'TOTTRDVAL', enableCellEdit: true, type: 'number', aggregationType: uiGridConstants.aggregationTypes.avg, treeAggregationType: uiGridGroupingConstants.aggregation.AVG, filters: [
        {
            condition: uiGridConstants.filter.GREATER_THAN,
            //            sort: {
    ...
    { name: 'DIFF%', type: 'number', field: 'DIFFPer', filters: [
     ...
     $scope.refreshData = function () {
         ...
         $http.get('http://localhost:3000/api/' + formattedDate)
